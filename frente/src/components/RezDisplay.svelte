...
<div class="max-w-4xl mx-auto p-6 space-y-6">
  <p class="text-4xl font-extrabold">Resultados de la revisión</p>

  <div class="bg-gray-100 p-4 rounded-lg mt-6">
    <h2 class="text-xl font-bold mb-3 text-primary-600">Valoración General</h2>
    <div class="space-y-2">
      <p>
  ...
  <div class="space-y-2 p-4">
    <p class="text-xl font-semibold mb-3 text-primary-500">Valoración de cada segmento</p>
